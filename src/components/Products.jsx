...
const Products = () => {
  ...
  backgroundPosition: 'center'
        ...
        <Card.Body>
          ...
          <Button variant="primary" style={{ width: '100%' }} className="btn btn-outline-dark btn-sm m-2" onClick={() => filterProduct("men's clothing")}>Bracelet</Button>
        </Card.Body>
      </Card>
      ...
      <Card style={{
        ...
        <Card.Body>
          ...
          <Button variant="primary" style={{ width: '100%' }} className="btn btn-outline-dark btn-sm m-2" onClick={() => filterProduct("women's clothing")}>
          Earrings</Button>
        </Card.Body>
      </Card>
